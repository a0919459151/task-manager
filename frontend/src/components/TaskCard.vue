<template>
  <div class="bg-white rounded-lg shadow-sm p-5 mb-4">
      ...
      <div class="flex space-x-2">
        <button @click="editTask" class="text-gray-500 hover:text-blue-500 transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            <path
              d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zm-3.111 5.343L.364 17.636a.5.5 0 00.22.219l.793.793a.5.5 0 00.22.219l12.28-12.28-2.828-2.828L7.475 7.475z" />
          </svg>
        </button>
    ...
    <div :class="statusBadgeClass" class="inline-block rounded-full px-3 py-1 text-xs font-semibold uppercase">{{
      task.status }}</div>
